...
exports.isValidEnumValue = exports.getEnumLength = void 0;
exports.getEnumLength = function (enumOBJ) {
    var keys = Object.keys(enumOBJ); //[키,키,키,키...]
    console.log({ msg: '여기는 열거객체 갯수 구하는 함수입니당', keys: keys });
    ...
    // });
    // ! 리듀서로 더 단순하게 구성
    var resultReduce = keys.reduce(function (acc, key) {
...
exports.isValidEnumValue = function (enumOBJ, value) {
